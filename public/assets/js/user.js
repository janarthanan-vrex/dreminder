...
categorySelect.on('change', function () {
    ...
    const err =
        document.getElementById('err-category_id');
...
function updateSubs() {
    ...
    if (cat && CATS[cat]) {
        ...
        const categoryName =
            CATS[cat].name.toLowerCase().trim();
        ...
        if (
            ...
            document.getElementById('opt-fields')
                .style.display = 'none';
...
async function submitReminder() {
    ...
    const btnText =
        document.getElementById('create-btn-txt');
    ...
    const data = {
        ...
        description:
            document.getElementById('r-desc')
            .value.trim(),

        provider:
            document.getElementById('r-provider')
            .value.trim(),
        ...
        payment_frequency:
            document.getElementById('r-freq')
            .value
    };
    ...
    Object.keys(result.errors).forEach(field => {
     ...
     btn.disabled = false;
        ...
        // 🔥 RESET FORM
        document.getElementById('rem-form')
            .reset();
        ...
        document.getElementById('desc-len')
            .innerText = '0';
...
function saveSubcategory() {
    ...
    const input =
        document.getElementById('new-sub-input');
