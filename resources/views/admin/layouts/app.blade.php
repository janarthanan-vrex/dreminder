...
═══════════════════════════════════ -->
            ...
            <div class="modal-box">
                ...
                <div class="g2" style="margin-bottom: 14px">
                    <div>
                        ...
                        ><input class="inp" id="au-fname" placeholder="John" />
                    </div>
                    <div>
                        <label class="label">Last Name <span style="color: var(--red)">*</span></label
                        ><input class="inp" id="au-lname" placeholder="Smith" />
                    </div>
                </div>
                <div style="margin-bottom: 14px">
                    <label class="label">Email <span style="color: var(--red)">*</span></label
                    ><input class="inp" id="au-email" type="email" placeholder="john@example.com" />
                </div>
                <div class="g2" style="margin-bottom: 14px">
                    <div>
                        <label class="label">Plan</label
                        ><select class="inp" id="au-plan">
            ...
            <div class="modal-box">
                ...
                <div class="g2" style="margin-bottom: 14px">
                    <div>
                        ...
                        ><input class="inp" id="eu-name" placeholder="Full name" />
                    </div>
                    <div>
                        <label class="label">Email <span style="color: var(--red)">*</span></label
                        ><input class="inp" id="eu-email" type="email" placeholder="Email" />
                    </div>
                </div>
                <div class="g2" style="margin-bottom: 14px">
                    <div>
                        <label class="label">Plan</label
                        ><select class="inp" id="eu-plan">
                            <option>Basic Annual</option>
                            <option>Pro</option>
                            <option>Free</option>
                        </select>
        ...
        <div class="modal-bg" id="add-staff-modal">
            <div class="modal-box">
                ...
                <div class="g2" style="margin-bottom: 14px">
                    <div>
                        <label class="label">Full Name <span style="color: var(--red)">*</span></label
                        ><input class="inp" id="as-name" placeholder="Jane Doe" />
                    </div>
                    <div>
                        <label class="label">Email <span style="color: var(--red)">*</span></label
                        ><input class="inp" id="as-email" placeholder="jane@dremind.co.uk" />
                    </div>
                </div>
                ...
                <div class="g2" style="margin-bottom: 14px">
                    <div>
                        ...
                        ><select class="inp" id="staff-role-sel">
                            <option value="">Select role…</option>
                        </select>
                    </div>
                    <div>
                        <label class="label">Department</label
                        ><select class="inp" id="as-dept">
            ...
            <div class="modal-box">
                ...
                <div class="g2" style="margin-bottom: 14px">
                    <div>
                        ...
                        ><select class="inp" id="es-role"></select>
                    </div>
                    <div>
                        <label class="label">Status</label
        ...
        <div class="modal-bg" id="send-notif-modal">
            <div class="modal-box">
                ...
                <div style="margin-bottom: 18px">
                    ...
                    ><textarea class="inp" rows="3" placeholder="Message…" style="resize: none"></textarea>
                </div>
                <div style="display: flex; gap: 8px; justify-content: flex-end">
        ...
        <div class="modal-bg" id="add-category-modal">
            <div class="modal-box">
                <div class="modal-header">
                    <div>
                        <h3 class="font-jakarta" style="font-weight: 700; font-size: 0.95rem; color: var(--text)">
                            <i class="ri-folder-add-line" style="color: var(--amber); margin-right: 6px"></i>Add
                            Category
                        </h3>
                        <p style="font-size: 0.76rem; color: var(--text3); margin-top: 2px">
                ...
                <div style="margin-bottom: 14px">
                    ...
                    ><input class="inp" placeholder="e.g. Fitness" />
                </div>
                <div class="g2" style="margin-bottom: 14px">
                    <div>
                        <label class="label">Icon (Remixicon class)</label
                        ><input class="inp" placeholder="ri-heart-line" />
                    </div>
                    <div>
                        <label class="label">Colour</label
                        ><input class="inp" type="color" value="#7c3aed" style="height: 42px; padding: 4px" />
                    </div>
                </div>
                <div style="margin-bottom: 18px">
                    <label class="label">Description</label><input class="inp" placeholder="Brief description…" />
                </div>
                <div style="display: flex; gap: 8px; justify-content: flex-end">
                    <button class="btn btn-ghost btn-sm" onclick="closeModal('add-category-modal')">Cancel</button>
                    <button
                        class="btn btn-primary btn-sm"
                        onclick="toast('Category created!','success');closeModal('add-category-modal')"
                    >
         ...
         <div class="modal-bg" id="add-subcategory-modal">
            <div class="modal-box">
                ...
                <div style="margin-bottom:14px">
                    ...
                    <select class="inp" id="subcategory-parent"></select>
                </div>

                <div style="margin-bottom:14px">
                    <label class="label">Subcategory Name <span style="color:var(--red)">*</span></label>
                    <input class="inp" id="subcategory-name" placeholder="e.g. Car Insurance" />
                </div>
        ...
        <div class="modal-bg" id="confirm-modal">
            <div class="modal-box" style="max-width: 420px">
                ...
                <p
                    id="confirm-msg"
                    style="font-size: 0.85rem; color: var(--text2); margin-bottom: 24px; line-height: 1.6"
                ></p>
                <div style="display: flex; gap: 8px; justify-content: flex-end">
