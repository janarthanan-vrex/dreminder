  ...
  <div class="max-w-7xl mx-auto px-6 lg:px-8">
    <div class="flex items-center justify-between h-[76px]">
      ...
      <div class="hidden md:flex items-center gap-3 nav-cta-desktop z-20">
        <a href="{{route('loginpage')}}" class="nav-link" data-page="login">Login</a>
        <a href="{{route('registerpage')}}" class="btn-primary text-sm !py-[11px] !px-6"><i class="ri-user-add-line text-base"></i>Register</a>
      </div>
    ...
    <div class="mob-menu" id="mobMenu"><div class="pb-6 pt-2 flex flex-col gap-1 px-2">
      <a href="{{route('index')}}" class="nav-link block !text-base">Home</a><a href="{{route('about')}}" class="nav-link block !text-base">About</a><a href="category" class="nav-link block !text-base">Category</a><a href="{{route('faq.page')}}" class="nav-link block !text-base">FAQ</a><a href="{{route('contact')}}" class="nav-link block !text-base">Contact</a><a href="{{route('loginpage')}}" class="nav-link block !text-base">Login</a>
      <a href="{{route('registerpage')}}" class="btn-primary text-center mt-2">Register</a>
    </div></div>
  </div>
</nav>
