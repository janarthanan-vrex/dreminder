...
═══════════════════════════════════════════════════════ -->
  <div id="page-register" class="page active">
    <div class="stage">
      ...
      <!-- ─── REGISTER A ─────────────────────────────────── -->
      <div id="register-v1" class="variant active">
        <div class="em">
          <div class="em-stripe stripe-blue"></div>

          <div class="em-hero">
            <div class="icon-ring blue">
              <img src="https://www.vishakarex.in/assets/img/projects/d-remind.png" alt="">
            </div>
            <h1 class="em-h1">Welcome to DRemind,<br><em>{{ $user->first_name }} {{ $user->last_name }}.</em></h1>
            <p class="em-sub">Your account is ready. Start managing your reminders and never miss an important date again.</p>
          </div>

          <div class="em-divider"></div>

          <div class="em-body">
            <p class="body-p">Hi <strong>{{ $user->first_name }} {{ $user->last_name }}</strong>, here are your login credentials. You can log in to your account using the details below.</p>

            <!-- <div class="creds">
        <div class="creds-head">
          <svg width="11" height="11" fill="none" viewBox="0 0 24 24" stroke="#9C9890" stroke-width="2.5"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
          Your Login Credentials
        </div>
        <div class="cred-item">
          <div class="cred-icon">
            <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke="#6B6860" stroke-width="2">
              <rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/>
            </svg>
          </div>
          <div>
            <span class="cred-label">Email Address</span>
            <span class="cred-value">arun.kumar@example.com</span>
          </div>
        </div>
        <div class="cred-item">
          <div class="cred-icon">
            <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke="#6B6860" stroke-width="2">
              ...
              <path d="M9.36 5.4A9.03 9.03 0 0 1 12 5c4 0 7.56 2.29 9.31 5.68"/>
              <path d="M17.04 16.04A9.03 9.03 0 0 1 12 19c-4 0-7.56-2.29-9.31-5.68"/>
            </svg>
          </div>
          <div>
            <span class="cred-label">Temporary Password</span>
            <div class="cred-password">
              <span class="cred-value mono pw-dots">&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;</span>
              <span class="pw-tag">Hidden for security</span>
            </div>
          </div>
        </div>
      </div> -->
            ...
            <!-- <div class="notice amber">
              ...
              <div>
                <p class="notice-title">Change your password after first login</p>
                <p class="notice-text">For your security, a temporary password was sent to your registered email. Please log in and update it immediately from your profile settings.</p>
              </div>
            </div> -->

            <div class="btn-row">
              <a href="{{ route('user.magic.login', ['id' => $user->id, 'token' => $user->email_verification_code]) }}" class="em-btn blue">
                Access Dashboard &nbsp;
            ...
            <div style="text-align:center;margin-top:10px">
              <span style="font-size:12px;color:#B8B3AA">Having trouble? Contact <a href="mailto:support@dremind.co.uk" style="color:#1D4ED8;text-decoration:none;font-weight:600">support@dremind.co.uk</a></span>
            </div>
          </div>

          <div class="em-footer">
            <p>This email was sent because an account was created for this address.</p>
            <p style="margin-top:4px">&copy; {{ now()->year }} Winngoo infotech. All rights reserved</p>
          </div>
          <div class="em-stripe stripe-blue em-bottom-stripe"></div>
        </div>
      </div><!-- /register-v1 -->
